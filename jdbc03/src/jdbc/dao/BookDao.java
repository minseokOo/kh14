...
public class BookDao {
	...
	public void insert(BookDto dto) {
		...
		Object[] data = { dto.getBookTitle(), dto.getBookAuthor(), dto.getBookPublication(), dto.getBookPrice(),
				dto.getBookPublisher(), dto.getBookPage(), dto.getBookGenre() };
	...
	public boolean update(BookDto dto) {
		...
		String sql = "update book "
				...
				+ "where book_id=? ";
		Object[] data = { dto.getBookTitle(), dto.getBookAuthor(), dto.getBookPublication(), dto.getBookPrice(),
				dto.getBookPublisher(), dto.getBookPage(), dto.getBookGenre(), dto.getBookId() 
				};
