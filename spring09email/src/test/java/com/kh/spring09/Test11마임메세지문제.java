...
public class Test11마임메세지문제 {
	...
	public void test() throws MessagingException, IOException {
		...
		String url = "https://kh-academy.co.kr/main/main.kh";
		...
		helper.setSubject("[KH정보교육원] 인증번호 발송");
		...
		Element receiver = document.getElementById("identifyNumber");// #receiver 탐색
		receiver.text(value);
